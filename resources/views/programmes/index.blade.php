...
@section("title", "Liste des programme")
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mt-3 mr-3 mb-5">
                    <a href="{{ route('programmes.create') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        @foreach ($programmes as $programme)
                            <tr>
                                ...
                                <td>{{ $programme->diplome_1->nomDiplome }}</td>
                                <td>{{ $programme->diplome_2->nomDiplome }}</td>
                                <td class="d-flex justify-content-around">
                                    <a href="{{ route('programmes.edit', $programme) }}"> <i class="fa fa-pencil text-secondary" aria-hidden="true"></i> </a>
                                    <a onclick="show_alerte(`{{ route('programmes.destroy', $programme) }}`)" class="waves-effect waves-light sa-warning"> <i class="fa fa-trash text-danger" aria-hidden="true"></i> </a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
